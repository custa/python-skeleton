...
def save_model(model_path):
    ...
    with tf.Session() as sess:
        ...
        tf.saved_model.simple_save(
            sess, model_path, inputs={
                'input0': x_input}, outputs={
                'output0': conv})
        # here we use simple_save method to save model,but actually tensorflow indeed use the
        # save_model_builder to save model behind with default signature KEY
        # (as well as we defined as "my_signature")
